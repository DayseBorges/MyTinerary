...
const itineraryControllers = {
    postItinerary: async (req, res) => {
        const {name, url, city, description, price, duration, creatorName, likes} = req.body
        ...
        try {
            ...
            let itinerary = await itineraryService.createItinerary({name, url, city: findedCity._id, description, price, duration, creatorName, likes})
